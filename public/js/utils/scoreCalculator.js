 ...
 */
export function calculateBaseScore(isCorrect, timeMs) {
...
export function calculateStreakBonus(streak) {
  ...
  const entries = Object.entries(CONSTANTS.STREAK_BONUSES).sort((a, b) => b[0] - a[0]);
  
  for (const [requiredStreak, bonus] of entries) {
 ...
 */
export function calculateScore(isCorrect, timeMs, streak = 0) {
